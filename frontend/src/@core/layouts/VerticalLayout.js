  ...
  return (
    ...
    >
      ...
      <Navbar
        ...
        className={classnames(
          `header-navbar navbar align-items-center px-5 ${navbarClasses['static'] || 'floating-nav'}`
        )}
      >
        ...
        {name ? (
          <div>
            <UncontrolledButtonDropdown className='nav-dropdown mx-2'>
            ...
            <Button.Ripple color='primary' outline className="primary-btn" onClick={() => logout()}>
              Log out
            </Button.Ripple>
          </div>
        ) : (
