    ...
    <Modal isOpen={checkEmailModal} toggle={() => setCheckEmailModal(!checkEmailModal)} className='modal-dialog-centered checkEmail-modal'>
      ...
      <ModalBody>
        <div className='px-3 text-center'>
          {iconEmail}
          <h1 className='mt-3 mb-2'>Check your email!</h1>
          <p className='mb-3 font-medium-1'>We emailed a magic link to {email}<br/> Click the link to log in or sign up</p>
          <div className='mb-2'>
            <a color='flat-dark' className="btn email-btn gmail-btn" href={gmailUrl} target='_blank'>
              {gmailIcon}
              <span className='align-middle ms-1'>Open Gmail</span>
            </a>
          </div>
          <div className='mb-3'>
            <a color='flat-dark' className="btn email-btn outlook-btn" href={outlookUrl} target='_blank'>
              {outlookIcon}
              <span className='align-middle ms-1'>Open Outlook</span>
            </a>
          </div>
        </div>
      </ModalBody>
